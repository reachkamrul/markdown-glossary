...
![Screenshot of Markdown](https://github.com/reachkamrul/markdown-glossary/blob/main/screenshot.png)
...
* On-Hover Tooltips: Displays a concise definition as a tooltip when a user hoover over a linked term.
